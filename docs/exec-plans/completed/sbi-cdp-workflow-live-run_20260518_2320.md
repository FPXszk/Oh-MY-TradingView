...
- [x] Step 1: 関連 docs / workflow / session log を確認し、今回の前提を固定する
- [x] Step 2: exec-plan を保存し、docs-only commit と push を行う
- [x] Step 3: `SBI Portfolio Capture` workflow を dispatch する
- [x] Step 4: 最新 run の status / failed log / artifact 可用性を確認する
- [x] Step 5: session log を記録し、exec-plan を completed へ移動して commit / push する
