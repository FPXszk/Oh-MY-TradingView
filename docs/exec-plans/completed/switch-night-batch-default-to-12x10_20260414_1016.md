...
- README / `docs/command.md` / `docs/explain-forhuman.md` の運用説明
...
- `docs/exec-plans/active/document-self-hosted-runner-foreground-autostart_20260412_0006.md`
  - `README.md` / `docs/command.md` を触る点が重なる
...
- 実装前に最新 `main` と active plans の差分を確認し、`README.md` / `docs/command.md` の競合を先に解消する
...
- [ ] `README.md` / `docs/command.md` / `docs/explain-forhuman.md` のうち、**既定値説明を持つ箇所だけ**を特定する
...
- [ ] `docs/command.md` の foreground config / workflow 既定説明を 12x10 基準へ更新する
- [ ] `docs/explain-forhuman.md` の「今の workflow 既定値で何が走るのか」周辺を 12x10 基準へ更新する
...
- `README.md` / `docs/command.md` は active plan と競合しやすい
...
- `docs/explain-forhuman.md` には「latest docs と workflow 既定値は別」という説明があるため、12x10 へ切り替え後は論理矛盾が出ないよう更新範囲をまとめて直す必要がある
