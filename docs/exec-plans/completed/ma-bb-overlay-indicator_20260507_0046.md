...
- [x] 既存 repo の Pine 配置方針と命名に合わせて保存先を確定する
- [x] MA 5/25/50/100/200 と BB14 を表示する overlay indicator を新規作成する
- [x] 静的解析または repo 既存 CLI で Pine の妥当性を確認する
- [x] レビュー観点で、過剰機能がないこととコピペ登録しやすいことを確認する
- [x] 完了後、plan を `completed/` に移し、変更を Conventional Commit で commit / push する

## テスト戦略

- `node src/cli/index.js pine analyze --file docs/references/pine/custom-indicators/ma-bb-overlay-5-25-50-100-200-bb14.pine`
