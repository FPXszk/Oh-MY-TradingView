...
- これは **deep research に基づく候補整理**。実機結果は別紙 [`mag7-backtest-results_2015_2025.md`](./mag7-backtest-results_2015_2025.md) と raw snapshot [`../references/backtests/mag7-backtest-results_20260404.json`](../references/backtests/mag7-backtest-results_20260404.json) を正本とする
...
## バックテスト実行結果 (2026-04-04)

- TradingView 実機 run は **70/70 完走**
...
### Core Strategies (実測トップ3)

| rank | strategy_id | reason |
|---|---|---|
| 1 | `sma-200-trend-filter` | 平均純利益が突出し、今後の改善対象として最優先 |
| 2 | `donchian-breakout` | breakout 系として安定して高く、改善余地も明確 |
| 3 | `supertrend-atr` | PF と DD のバランスが良く、調整実験に向く |

今後の改善ループでは、まずこの 3 戦略を **core strategies** として扱う。
