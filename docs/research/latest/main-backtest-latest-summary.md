...
ここでいう `latest` は **利用可能な最新 main backtest artifact から再生成した summary** を指し、`docs/research/latest/README.md` にある handoff generation の `latest` とは別概念です。
...
- failed_step: `—`
- last_checkpoint: `—`
- us_results: `docs/research/results/campaigns/next-long-run-us-finetune-100x10/smoke/recovered-results.json`
- jp_results: `docs/research/results/campaigns/next-long-run-jp-finetune-100x10/smoke/recovered-results.json`
- rich_report: `docs/research/results/night-batch/main-backtest-latest-rich-report.md`
- ranking_artifact: `docs/references/backtests/main-backtest-latest-combined-ranking.json`
- strategy_catalog_snapshot: `docs/research/results/night-batch/main-backtest-latest-strategy-catalog.snapshot.json`
- strategy_reference: `docs/research/strategy/latest-strategy-reference.md`
- symbol_reference: `docs/research/strategy/latest-symbol-reference.md`
