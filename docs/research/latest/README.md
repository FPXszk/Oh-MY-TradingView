...
1. この `README.md`
2. `main-backtest-latest-summary.md`
...
6. 判断経緯が必要なら `../../working-memory/session-logs/archive/next-long-run-us-jp-12x10-registration_20260414_0009.md`
...
- strongest set は `config/backtest/strategy-presets.json` の 15 戦略に圧縮済み
