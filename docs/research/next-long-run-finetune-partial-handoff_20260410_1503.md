...
| artifact | path |
| --- | --- |
| US pilot checkpoint | `results/campaigns/next-long-run-us-finetune-100x10/pilot/checkpoint-50.json` |
| US full checkpoint | `results/campaigns/next-long-run-us-finetune-100x10/full/checkpoint-490.json` |
