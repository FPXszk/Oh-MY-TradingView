...
1. `docs/research/archive/top4-period-slicing-handoff_20260407_1641.md`
2. `docs/research/archive/top4-period-slicing-results_20260407_1641.md`
3. `docs/command.md` の長時間 workload 指針
4. `logs/sessions/tradingview-parallel-backtest-stabilization_20260406_0802.md`
