...
describe('foreground bundle config default campaign', () => {
  ...
  it('us_campaign defaults to selected-us40-8pack', () => {
    assert.equal(config.bundle.us_campaign, 'selected-us40-8pack',
      'bundle-foreground-reuse-config.json must default us_campaign to selected-us40-8pack');
  });
