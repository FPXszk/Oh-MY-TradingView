...
describe('buildMarkdown', () => {
  ...
  it('renders phase1 sector ranking, phase2 sector breakdown, and market coverage', () => {
    ...
    assert.match(markdown, /\| 順位 \| テーマ \| 通過銘柄数 \| 平均3M \| 平均総合点 \| 外部確認数 \| 外部確認 \| 主な細粒度タグ \|/);
    assert.match(markdown, /\| 1 \| Cloud Software \| 2 \| 27\.5% \| 88\.40 \| 4 \| Morningstar, MSCI, Nasdaq, moomoo \| Cloud Platforms, Data Infrastructure Software \|/);
