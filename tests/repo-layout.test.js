...
describe('repository layout policy', () => {
  ...
  it('prunes strategy-presets.json to 11 live strategies and records retired strategies', () => {
    const expectedLiveStrategies = 11;
  ...
  it('strategy-catalog.json exists and has 13 strategies', () => {
    ...
    assert.equal(catalog.strategies.length, 13, `expected 13 strategies in catalog, got ${catalog.strategies.length}`);
  });
