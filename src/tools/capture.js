...
export function registerCaptureTools(server) {
  server.tool(
    ...
    'Capture a screenshot of the current TradingView Desktop page via CDP. If outputPath is provided, save under results/screenshots without overwriting.',
    {
      outputPath: z.string().optional()
        .describe('Relative file path under results/screenshots (returns base64 if omitted)'),
