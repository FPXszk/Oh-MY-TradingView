...
| 売買判断・保有判断・ポートフォリオ判断 | [docs/strategy/Trade-rule.md](docs/strategy/Trade-rule.md) | [.agents/skills/trade-decision-gate/SKILL.md](.agents/skills/trade-decision-gate/SKILL.md)、[.agents/skills/tradingview-operator-playbook/SKILL.md](.agents/skills/tradingview-operator-playbook/SKILL.md) | [tests/skills-contract.test.js](tests/skills-contract.test.js) |
